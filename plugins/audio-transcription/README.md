...
Transcribe audio files by dropping them into Openstyle — no microphone needed.

This is a first-party Openstyle plugin. It adds a **Transcribe Files** page where
...
Audio is sent only to the Openstyle server you've configured — your local
