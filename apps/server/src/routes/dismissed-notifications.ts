 ...
 * Presence of a key means the corresponding UI has been dismissed. Stored in
 * the local (or configured remote) server's SQLite DB, the same place
 * settings/vocabulary live.
 */
